...
net=BiDeformableConvLSTM(input_size=(48,48), input_dim=64, hidden_dim=64,kernel_size=(3,3), num_layers=1, batch_first=True, front_RBs=5, groups=8)
net = net.cuda()
